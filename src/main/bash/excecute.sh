...
gcloud dataproc jobs submit spark --region us-central1 --cluster demo-cluster --async --jar target/$JAR --properties $SPARK_PROPERTIES -- gs://datazzz/5k 0.00001 200 true 5 10 0 5 furthest_in_cluster 0.05 50 12